...
public:
    ...
    virtual void selectSPI() = 0;
    virtual void releaseSPI() = 0;
...
protected:
    ...
    virtual void showColor(const struct CRGB & data, int nLeds, CRGB scale) {
        ...
        pixels = new PixelController<RGB_ORDER, LANES, MASK>(data, nLeds, scale, getDither());
    }
    ...
    virtual void show(const struct CRGB *data, int nLeds, CRGB scale) {
        ...
        pixels = new PixelController<RGB_ORDER, LANES, MASK>(data, nLeds < 0 ? -nLeds : nLeds, scale, getDither());
        if(nLeds < 0) {
